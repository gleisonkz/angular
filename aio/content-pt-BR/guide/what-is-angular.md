# O que é Angular (from pt-BR)?

Este tópico pode ajudá-lo a entender o Angular: o que é o Angular, quais vantagens ele oferece e o que você pode esperar ao começar a criar seus aplicativos.

Angular é uma plataforma de desenvolvimento, construída em [TypeScript](https://www.typescriptlang.org).
