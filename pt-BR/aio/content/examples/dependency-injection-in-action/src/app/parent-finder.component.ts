...
@Component({selector: 'carol', template: templateC})
...
@Component({selector: 'chris', template: templateC})
...
@Component({selector: 'bob', template: templateB, providers: [provideParent(BobComponent)]})
