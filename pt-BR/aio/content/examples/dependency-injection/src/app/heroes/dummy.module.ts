...
@NgModule(
    {imports: [CommonModule], declarations: [HeroListComponent1], exports: [HeroListComponent1]})
...
@NgModule({imports: [CommonModule], declarations: [HeroListComponent2]})
...
@NgModule({imports: [CommonModule, DummyModule1], declarations: [HeroesComponent1]})
